...
use AawTeam\Adserver\Domain\Repository\CampaignRepository;
use AawTeam\Adserver\Persistence\AbstractIdentifiableManagerRepository;
use Nimut\TestingFramework\TestCase\UnitTestCase;

/**
 * CampaignRepositoryTest
 */
class CampaignRepositoryTest extends UnitTestCase
{
    ...
    {
        self::assertContains(AbstractIdentifiableManagerRepository::class, class_parents(CampaignRepository::class));
    }
}
